...
namespace Interchée.Migrations
{
    ...
    [Migration("20251001092916_UpdateSubmissionRepositoryMethods")]
    partial class UpdateSubmissionRepositoryMethods
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Interchée.Entities.AssignmentAttachment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Interchée.Entities.AssignmentSubmission", b =>
                {
                    ...
                    b.HasIndex("AssignmentId", "InternId")
                        .IsUnique();
            ...
            modelBuilder.Entity("Interchée.Entities.Feedback", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Interchée.Entities.Grade", b =>
                {
                    ...
                    b.Property<string>("RubricEvaluationJson")
                        .HasMaxLength(4000)
                        .HasColumnType("nvarchar(4000)");
            ...
            modelBuilder.Entity("Interchée.Entities.Assignment", b =>
                {
                    b.HasOne("Interchée.Entities.AppUser", "CreatedBy")
                        .WithMany()
            ...
            modelBuilder.Entity("Interchée.Entities.AssignmentSubmission", b =>
                {
                    ...
                    b.HasOne("Interchée.Entities.AppUser", "Intern")
                        .WithMany()
            ...
            modelBuilder.Entity("Interchée.Entities.Grade", b =>
                {
                    b.HasOne("Interchée.Entities.AppUser", "GradedBy")
                        .WithMany()
