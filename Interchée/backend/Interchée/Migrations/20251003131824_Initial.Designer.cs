...
namespace Interchée.Migrations
{
    ...
    [Migration("20251003131824_Initial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Interchée.Entities.AbsenceDecision", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("Interchée.Entities.AbsenceLimitPolicy", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<decimal>("MaxDaysPerTerm")
                        .HasPrecision(5, 2)
                    ...
                    b.HasIndex("Scope", "DepartmentId", "EffectiveFrom");

                    b.ToTable("AbsenceLimitPolicies");
                });
            ...
            modelBuilder.Entity("Interchée.Entities.AbsenceDecision", b =>
                {
                    b.HasOne("Interchée.Entities.AppUser", "DecidedByUser")
                        .WithMany()
                        .HasForeignKey("DecidedByUserId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("Interchée.Entities.AbsenceRequest", "Request")
                        .WithOne("Decision")
                        .HasForeignKey("Interchée.Entities.AbsenceDecision", "RequestId")
