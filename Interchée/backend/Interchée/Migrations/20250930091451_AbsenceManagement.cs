...
{
    /// <inheritdoc />
    public partial class AbsenceManagement : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CourseOfStudy = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Interns_AspNetUsers_SupervisorId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_AbsenceRequests_Interns_InternId",
                        column: x => x.InternId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AbsenceRequests_EndDate",
                table: "AbsenceRequests",
                column: "EndDate");

            migrationBuilder.CreateIndex(
                name: "IX_AbsenceRequests_InternId",
                table: "AbsenceRequests",
                column: "InternId");

            migrationBuilder.CreateIndex(
                name: "IX_AbsenceRequests_InternId_Status",
                table: "AbsenceRequests",
                columns: new[] { "InternId", "Status" });

            migrationBuilder.CreateIndex(
                name: "IX_AbsenceRequests_RequestedAt",
                table: "AbsenceRequests",
                column: "RequestedAt");

            migrationBuilder.CreateIndex(
                name: "IX_AbsenceRequests_StartDate",
                table: "AbsenceRequests",
                column: "StartDate");

            migrationBuilder.CreateIndex(
                name: "IX_AbsenceRequests_StartDate_EndDate",
                table: "AbsenceRequests",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AbsenceRequests_Status_RequestedAt",
                table: "AbsenceRequests",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Interns_EndDate",
                table: "Interns",
                column: "EndDate");

            migrationBuilder.CreateIndex(
                name: "IX_Interns_StartDate",
                table: "Interns",
                column: "StartDate");

            migrationBuilder.CreateIndex(
                name: "IX_Interns_StartDate_EndDate",
                table: "Interns",
                columns: new[] { "StartDate", "EndDate" });

            migrationBuilder.CreateIndex(
                name: "IX_Interns_Status",
                table: "Interns",
                column: "Status");
